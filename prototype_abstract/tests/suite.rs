use prototype_abstract::test_case::{DragTestCase, check_test_case_all_transforms};
...
pub fn run_test_case(content: &str) {
    ...
    check_test_case_all_transforms(&test_case, false, false).unwrap();
}
...
pub fn run_test_case_reverse(content: &str) {
    ...
    check_test_case_all_transforms(&test_case, true, false).unwrap();
}
...
pub fn run_test_case_wiggle(content: &str) {
    ...
    check_test_case_all_transforms(&test_case, false, true).unwrap();
}
...
pub fn run_test_case_wiggle_reverse(content: &str) {
    ...
    check_test_case_all_transforms(&test_case, true, true).unwrap();
}
